...
final class SmithWilsonCurveInterpolator
    implements CurveInterpolator, Serializable {

  /**
   * The interpolator name.
   */
  public static final String NAME = "SmithWilson";
  /**
   * The interpolator instance.
   */
  public static final CurveInterpolator INSTANCE = new SmithWilsonCurveInterpolator();
   ...
   */
  private SmithWilsonCurveInterpolator() {
  }
